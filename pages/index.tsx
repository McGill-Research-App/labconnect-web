import { Box, Code, Text, Link, VStack, Grid, Heading, Flex, Stack, Button, Image } from "@chakra-ui/react"
    ...
    >
      ...
      >
        ...
        <Heading
          ...
          textAlign={["center", "center", "left", "left"]}
        >
          We make finding labs, professors, and research jobs that match your interests easy.
        </Heading>
        <Link to="">
          <Button
            colorScheme="primary"
